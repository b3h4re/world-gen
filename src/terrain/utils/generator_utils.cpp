...
bool isInsideRectangle(glm::ivec2 pos, glm::ivec2 dir, glm::ivec2 cpos1, glm::ivec2 cpos2) {
    ...
    return corner1.x <= newPos.x && newPos.x <= corner2.x &&
           corner1.y <= newPos.y && newPos.y <= corner2.y;
}
